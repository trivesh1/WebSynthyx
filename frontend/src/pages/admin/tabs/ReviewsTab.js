...
export default function ReviewsTab({ reviews, approveReview, deleteReview }) {
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white">Reviews</h1>
        <p className="text-gray-400 mt-2">Manage customer reviews and approvals</p>
      </div>
        ...
        <table className="w-full">
          <thead className="border-b border-white/10 text-gray-300">
            <tr>
              ...
              <th className="text-left px-6 py-3 font-semibold text-sm">Rating</th>
              <th className="text-left px-6 py-3 font-semibold text-sm">Message</th>
            ...
            {reviews.length === 0 ? (
              ...
              reviews.map((review, index) => (
                <tr
                  ...
                  data-testid={`admin-review-${index}`}
                >
                  <td className="px-6 py-4 text-white">{review.name}</td>
                  ...
                  <td className="px-6 py-4">
                    {review.approved ? (
                      <span className="inline-flex px-2 py-1 rounded-full text-xs bg-green-500/20 text-green-400">
                        Approved
                      </span>
                    ) : (
                      <span className="inline-flex px-2 py-1 rounded-full text-xs bg-yellow-500/20 text-yellow-400">
                        Pending
                      </span>
                    )}
                  </td>
